...
// Insert solution to programming project 5, chapter -1 here
    ...
    private AVLNode<E> add(AVLNode<E> localRoot, E item) {
        ...
        } else { // item > data programming exercise 2, section 2, chapter 9 here
            localRoot.right = add((AVLNode<E>) localRoot.right, item);
            if (increase) {
                incrementBalance(localRoot);
                if (localRoot.balance > AVLNode.RIGHT_HEAVY) {
                    increase = false;
                    //rebalance right here
    ...
    private AVLNode<E> rebalanceLeft(AVLNode<E> localRoot) {
        ...
        // See whether left-right heavy. //if left subtree has a positive balance (L-R case)
        if (leftChild.balance > AVLNode.BALANCED) {
            // Obtain reference to left-right child.
            AVLNode<E> leftRightChild = (AVLNode<E>) leftChild.right;
            // Adjust the balances to be their new values after
            // the rotations are performed.
            //if left subtree has negative balance (LEFT RIGHT LEFT CASE)
    ...
    private AVLNode<E> rebalanceRight(AVLNode<E> localRoot) {
        ...
        if (rightChild.balance < AVLNode.BALANCED) {
            ...
            // Adjust the balances to be their new values after
            // the rotations are performed.
            //if RIGHT subtree has negative balance (RIGHT LEFT LEFT CASE)
